...
/* 点击 block*/
typedef void (^ItemDidClick) (NSInteger index);
/* 回调属性*/
@property(nonatomic,strong) ItemDidClick didClick ;
...
//点击事件的回调
-(void)selectedItem: (ItemDidClick) block;


/* 暂时没什么用*/
extern const NSNotificationName clickedItem;
